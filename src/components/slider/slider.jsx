    ...
    return (
        <section className="main__slider slider">
            ...
            <div className="slider__preview-wrapper">
                ...
                <svg className={`slider__decor slider__decor--left ${currentSlideIndex === 0 ? "slider__decor--disabled" : ""}`} width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={handleSliderLeftClick}>
                ...
                <svg className={`slider__decor slider__decor--right ${currentSlideIndex === SLIDES.length - 1 ? "slider__decor--disabled" : ""}`} width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={handleSliderRightClick}>
