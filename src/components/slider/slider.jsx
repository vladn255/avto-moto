    ...
    return (
        <section className="main__slider slider">
            ...
            <div className="slider__preview-wrapper">
                ...
                <button className="slider__button slider__button--left" type="button" disabled={currentSlideIndex === 0} onClick={handleSliderLeftClick}>
                ...
                <button className="slider__button slider__button--right" type="button" disabled={currentSlideIndex === SLIDES.length - 1} onClick={handleSliderRightClick}>
